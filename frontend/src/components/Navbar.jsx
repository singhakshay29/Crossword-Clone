  ...
  return (
    <div className="fixed top-0 left-0 w-full z-50 bg-white">
      ...
      <div className="flex bg-[#FFE300] h-24">
        <Link to="/">
          <div className="p-4 w-60">
            <img
              src="https://www.crossword.in/cdn/shop/files/crossword_logo_small_bc561912-757f-49bc-b641-bab1dfb66c4e_small.svg?v=1697460508"
              alt="Logo"
            />
          </div>
        </Link>
        <div className="flex px-8 items-center w-full">
          <div className="w-5/6 px-16  flex ">
            <input
              className="w-full rounded h-10 px-4 text-sm"
              type="text"
          ...
          <div className="flex w-1/6">
            <Link to="/user/signin">
              ...
              >
                ...
                {user && (
                  <div className="bg-white w-24 h-10 rounded absolute cursor-pointer shadow-slate-300 shadow-lg">
                    <text className="flex justify-center font-700 text-center items-center mt-2 hover:text-red-400">
                      SIGN IN
                    </text>
                  </div>
                )}
      ...
      <div className="flex justify-center item-center font-montserrat font-bold bg-slate-100 h-8">
        {show ? (
          <div className="text-[#444444]">15% off on Books 📚</div>
        ) : (
